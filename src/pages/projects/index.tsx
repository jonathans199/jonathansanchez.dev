        ...
        <section className='min-h-screen'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
            {projects.map((project) => {
              const card = (
                <div className='bg-[var(--bg-card)] rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border border-red-600/20 h-full cursor-pointer'>
                  {/* Project Image */}
                    ...
                    {project.techStack && (
                      <div className='flex flex-wrap gap-1 mb-4'>
                        {project.techStack.slice(0, 3).map((tech, index) => (
                          <span
                            key={index}
                            className='px-2 py-1 bg-[var(--bg-card-hover)] text-red-400 rounded text-xs border border-red-600/20'
                          >
                            {tech}
                          </span>
                        ))}
                    ...
                    <div className='flex items-center space-x-3'>
                      {project.github && (
                        <span
                          ...
                          className='text-[var(--text-secondary)] hover:text-red-600 transition-colors duration-300'
                        >
                          <FaGithub size={18} />
                        </span>
                      )}
